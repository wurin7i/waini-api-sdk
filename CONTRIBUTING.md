...
* GitHub Issues: <https://github.com/waini/api-sdk/issues>
...
* waini/api-sdk follows a superset of **[PSR-12 coding standard][psr-12]**.
  Please ensure your code does, too. _Hint: run `composer dev:lint` to check._
* Please **write tests** for any new features you add.
* Please **ensure that tests pass** before submitting your pull request.
  waini/api-sdk automatically runs tests for pull requests. However,
...
[github]: https://github.com/waini/api-sdk
[issues]: https://github.com/waini/api-sdk/issues
[pull requests]: https://github.com/waini/api-sdk/pulls
